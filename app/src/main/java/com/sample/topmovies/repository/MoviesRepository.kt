...
import com.sample.topmovies.repository.network.MovieServiceImpl
...
class MoviesRepository @Inject constructor(private val movieServiceImpl: MovieServiceImpl) {
